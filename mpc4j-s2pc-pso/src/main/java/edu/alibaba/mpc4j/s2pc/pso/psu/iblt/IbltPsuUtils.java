...
class IbltPsuUtils {
     ...
     * @return IBLT.
     */
    static H5LongIblt createIblt(EnvType envType, int threshold, double multiplier, int valueByteLength, byte[] key) {
        return H5LongIblt.create(envType, threshold, multiplier, valueByteLength, key);
    }
